...
public class Row  implements java.io.Serializable {
    private com.easyinsight.validated.DatePair[] datePairs;

    private com.easyinsight.validated.NumberPair[] numberPairs;

    private com.easyinsight.validated.StringPair[] stringPairs;

    public Row() {
    }

    public Row(
           com.easyinsight.validated.DatePair[] datePairs,
           com.easyinsight.validated.NumberPair[] numberPairs,
           com.easyinsight.validated.StringPair[] stringPairs) {
     ...
     * @return datePairs
     */
    public com.easyinsight.validated.DatePair[] getDatePairs() {
        return datePairs;
    }
     ...
     * @param datePairs
     */
    public void setDatePairs(com.easyinsight.validated.DatePair[] datePairs) {
        this.datePairs = datePairs;
    }

    public com.easyinsight.validated.DatePair getDatePairs(int i) {
        return this.datePairs[i];
    }

    public void setDatePairs(int i, com.easyinsight.validated.DatePair _value) {
     ...
     * @return numberPairs
     */
    public com.easyinsight.validated.NumberPair[] getNumberPairs() {
        return numberPairs;
    }
     ...
     * @param numberPairs
     */
    public void setNumberPairs(com.easyinsight.validated.NumberPair[] numberPairs) {
        this.numberPairs = numberPairs;
    }

    public com.easyinsight.validated.NumberPair getNumberPairs(int i) {
        return this.numberPairs[i];
    }

    public void setNumberPairs(int i, com.easyinsight.validated.NumberPair _value) {
     ...
     * @return stringPairs
     */
    public com.easyinsight.validated.StringPair[] getStringPairs() {
        return stringPairs;
    }
     ...
     * @param stringPairs
     */
    public void setStringPairs(com.easyinsight.validated.StringPair[] stringPairs) {
        this.stringPairs = stringPairs;
    }

    public com.easyinsight.validated.StringPair getStringPairs(int i) {
        return this.stringPairs[i];
    }

    public void setStringPairs(int i, com.easyinsight.validated.StringPair _value) {
