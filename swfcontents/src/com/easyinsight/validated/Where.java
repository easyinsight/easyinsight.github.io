...
public class Where  implements java.io.Serializable {
    private com.easyinsight.validated.DateWhere[] dateWheres;

    private com.easyinsight.validated.DayWhere[] dayWheres;

    private com.easyinsight.validated.NumberWhere[] numberWheres;

    private com.easyinsight.validated.StringWhere[] stringWheres;

    public Where() {
    }

    public Where(
           com.easyinsight.validated.DateWhere[] dateWheres,
           com.easyinsight.validated.DayWhere[] dayWheres,
           com.easyinsight.validated.NumberWhere[] numberWheres,
           com.easyinsight.validated.StringWhere[] stringWheres) {
     ...
     * @return dateWheres
     */
    public com.easyinsight.validated.DateWhere[] getDateWheres() {
        return dateWheres;
    }
     ...
     * @param dateWheres
     */
    public void setDateWheres(com.easyinsight.validated.DateWhere[] dateWheres) {
        this.dateWheres = dateWheres;
    }

    public com.easyinsight.validated.DateWhere getDateWheres(int i) {
        return this.dateWheres[i];
    }

    public void setDateWheres(int i, com.easyinsight.validated.DateWhere _value) {
     ...
     * @return dayWheres
     */
    public com.easyinsight.validated.DayWhere[] getDayWheres() {
        return dayWheres;
    }
     ...
     * @param dayWheres
     */
    public void setDayWheres(com.easyinsight.validated.DayWhere[] dayWheres) {
        this.dayWheres = dayWheres;
    }

    public com.easyinsight.validated.DayWhere getDayWheres(int i) {
        return this.dayWheres[i];
    }

    public void setDayWheres(int i, com.easyinsight.validated.DayWhere _value) {
     ...
     * @return numberWheres
     */
    public com.easyinsight.validated.NumberWhere[] getNumberWheres() {
        return numberWheres;
    }
     ...
     * @param numberWheres
     */
    public void setNumberWheres(com.easyinsight.validated.NumberWhere[] numberWheres) {
        this.numberWheres = numberWheres;
    }

    public com.easyinsight.validated.NumberWhere getNumberWheres(int i) {
        return this.numberWheres[i];
    }

    public void setNumberWheres(int i, com.easyinsight.validated.NumberWhere _value) {
     ...
     * @return stringWheres
     */
    public com.easyinsight.validated.StringWhere[] getStringWheres() {
        return stringWheres;
    }
     ...
     * @param stringWheres
     */
    public void setStringWheres(com.easyinsight.validated.StringWhere[] stringWheres) {
        this.stringWheres = stringWheres;
    }

    public com.easyinsight.validated.StringWhere getStringWheres(int i) {
        return this.stringWheres[i];
    }

    public void setStringWheres(int i, com.easyinsight.validated.StringWhere _value) {
