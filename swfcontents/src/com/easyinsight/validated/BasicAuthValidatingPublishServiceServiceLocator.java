...
public class BasicAuthValidatingPublishServiceServiceLocator extends org.apache.axis.client.Service implements com.easyinsight.validated.BasicAuthValidatingPublishServiceService {
    ...
    private java.lang.String BasicAuthValidatingPublishServicePort_address = "https://www.easy-insight.com/app/services/ValidatedPublishBasic";
    ...
    public com.easyinsight.validated.BasicAuthValidatedPublish getBasicAuthValidatingPublishServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.easyinsight.validated.BasicAuthValidatedPublish getBasicAuthValidatingPublishServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.easyinsight.validated.BasicAuthValidatingPublishServiceServiceSoapBindingStub _stub = new com.easyinsight.validated.BasicAuthValidatingPublishServiceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.easyinsight.validated.BasicAuthValidatedPublish.class.isAssignableFrom(serviceEndpointInterface)) {
                com.easyinsight.validated.BasicAuthValidatingPublishServiceServiceSoapBindingStub _stub = new com.easyinsight.validated.BasicAuthValidatingPublishServiceServiceSoapBindingStub(new java.net.URL(BasicAuthValidatingPublishServicePort_address), this);
                _stub.setPortName(getBasicAuthValidatingPublishServicePortWSDDServiceName());
                return _stub;
            }
        }
