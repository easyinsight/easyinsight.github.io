...
public class InvalidateSessionsResponse {
    ...
    protected List<InvalidateSessionsResultType> result;
     ...
     * {@link InvalidateSessionsResultType }
     * 
     * 
     */
    public List<InvalidateSessionsResultType> getResult() {
        if (result == null) {
            result = new ArrayList<InvalidateSessionsResultType>();
        }
        return this.result;
    }
