...
public class EmptyRecycleBinResponse {
    ...
    protected List<EmptyRecycleBinResultType> result;
     ...
     * {@link EmptyRecycleBinResultType }
     * 
     * 
     */
    public List<EmptyRecycleBinResultType> getResult() {
        if (result == null) {
            result = new ArrayList<EmptyRecycleBinResultType>();
        }
        return this.result;
    }
