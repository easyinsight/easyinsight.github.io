...
public class ConvertLeadResponse {
    ...
    protected List<LeadConvertResultType> result;
     ...
     * {@link LeadConvertResultType }
     * 
     * 
     */
    public List<LeadConvertResultType> getResult() {
        if (result == null) {
            result = new ArrayList<LeadConvertResultType>();
        }
        return this.result;
    }
