...
public class RecordTypeMappingType {
    ...
    protected List<PicklistForRecordTypeType> picklistsForRecordType;
     ...
     * 
     */
    public List<PicklistForRecordTypeType> getPicklistsForRecordType() {
        if (picklistsForRecordType == null) {
            picklistsForRecordType = new ArrayList<PicklistForRecordTypeType>();
        }
