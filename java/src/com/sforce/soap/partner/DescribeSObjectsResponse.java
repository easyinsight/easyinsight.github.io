...
public class DescribeSObjectsResponse {
    ...
    protected List<DescribeSObjectResultType> result;
     ...
     * {@link DescribeSObjectResultType }
     * 
     * 
     */
    public List<DescribeSObjectResultType> getResult() {
        if (result == null) {
            result = new ArrayList<DescribeSObjectResultType>();
        }
        return this.result;
    }
