 ...
 * generated in the com.sforce.soap.enterprise.fault package. 
...
public class ObjectFactory {
    ...
    private final static QName _InvalidIdFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "InvalidIdFault");
    private final static QName _InvalidNewPasswordFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "InvalidNewPasswordFault");
    private final static QName _InvalidQueryLocatorFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "InvalidQueryLocatorFault");
    private final static QName _LoginFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "LoginFault");
    private final static QName _UnexpectedErrorFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "UnexpectedErrorFault");
    private final static QName _InvalidFieldFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "InvalidFieldFault");
    private final static QName _MalformedQueryFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "MalformedQueryFault");
    private final static QName _Fault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "fault");
    private final static QName _MalformedSearchFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "MalformedSearchFault");
    private final static QName _InvalidSObjectFault_QNAME = new QName("urn:fault.enterprise.soap.sforce.com", "InvalidSObjectFault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sforce.soap.enterprise.fault
     * 
     */
