...
/**
 * <p>Java class for CategoryNode complex type.
 * 
 ...
 *         &lt;element name="SortStyle" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "CategoryNode", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "lastModifiedBy",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "SortStyle", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> sortStyle;
    ...
    /**
     * Gets the value of the sortStyle property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getSortStyle() {
        return sortStyle;
    }

    /**
     * Sets the value of the sortStyle property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSortStyle(JAXBElement<String> value) {
        this.sortStyle = ((JAXBElement<String> ) value);
    }
