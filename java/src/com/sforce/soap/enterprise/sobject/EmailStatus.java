    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "EmailTemplateName", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> emailTemplateName;
    @XmlElementRef(name = "FirstOpenDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "LastOpenDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> lastOpenDate;
    @XmlElementRef(name = "Task", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Task> task;
    @XmlElementRef(name = "TaskId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> taskId;
    @XmlElementRef(name = "TimesOpened", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setEmailTemplateName(JAXBElement<String> value) {
        this.emailTemplateName = ((JAXBElement<String> ) value);
    }
    ...
    public void setFirstOpenDate(JAXBElement<XMLGregorianCalendar> value) {
        this.firstOpenDate = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
    ...
    public void setLastOpenDate(JAXBElement<XMLGregorianCalendar> value) {
        this.lastOpenDate = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
    ...
    public void setTask(JAXBElement<Task> value) {
        this.task = ((JAXBElement<Task> ) value);
    }
    ...
    public void setTaskId(JAXBElement<String> value) {
        this.taskId = ((JAXBElement<String> ) value);
    }
    ...
    public void setTimesOpened(JAXBElement<Integer> value) {
        this.timesOpened = ((JAXBElement<Integer> ) value);
    }
