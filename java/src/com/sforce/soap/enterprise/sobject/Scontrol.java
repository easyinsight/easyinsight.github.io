 ...
 *         &lt;element name="HtmlWrapper" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Binary", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<byte[]> binary;
    ...
    @XmlElementRef(name = "ContentSource", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> contentSource;
    ...
    @XmlElementRef(name = "DeveloperName", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "HtmlWrapper", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> htmlWrapper;
    ...
    @XmlElementRef(name = "SupportsCaching", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Boolean> supportsCaching;
     ...
     *     
     */
    public JAXBElement<byte[]> getBinary() {
        return binary;
    }
     ...
     *     
     */
    public void setBinary(JAXBElement<byte[]> value) {
        this.binary = ((JAXBElement<byte[]> ) value);
    }
    ...
    public void setContentSource(JAXBElement<String> value) {
        this.contentSource = ((JAXBElement<String> ) value);
    }
    ...
    public void setDeveloperName(JAXBElement<String> value) {
        this.developerName = ((JAXBElement<String> ) value);
    }
    ...
    /**
     * Gets the value of the htmlWrapper property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getHtmlWrapper() {
        return htmlWrapper;
    }

    /**
     * Sets the value of the htmlWrapper property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setHtmlWrapper(JAXBElement<String> value) {
        this.htmlWrapper = ((JAXBElement<String> ) value);
    }
     ...
     *     
     */
    public JAXBElement<Boolean> getSupportsCaching() {
     ...
     *     
     */
    public void setSupportsCaching(JAXBElement<Boolean> value) {
        this.supportsCaching = ((JAXBElement<Boolean> ) value);
    }
