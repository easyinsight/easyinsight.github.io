...
/**
 * <p>Java class for CaseContactRole complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Cases" type="{urn:sobject.enterprise.soap.sforce.com}Case" minOccurs="0"/>
 *         &lt;element name="CasesId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
...
@XmlType(name = "CaseContactRole", propOrder = {
    "cases",
    "casesId",
    "contact",
    "contactId",
    ...
    extends SObject
{
    ...
    protected JAXBElement<Case> cases;
    @XmlElementRef(name = "CasesId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> casesId;
     ...
     *     
     */
    public JAXBElement<Case> getCases() {
        return cases;
    }
     ...
     *     
     */
    public void setCases(JAXBElement<Case> value) {
        this.cases = ((JAXBElement<Case> ) value);
    }

    /**
     * Gets the value of the casesId property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getCasesId() {
        return casesId;
    }

    /**
     * Sets the value of the casesId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setCasesId(JAXBElement<String> value) {
        this.casesId = ((JAXBElement<String> ) value);
    }
