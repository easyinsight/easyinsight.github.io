 ...
 *         &lt;element name="LastUsedDate" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "BrandTemplateId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Encoding", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "HtmlValue", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "TemplateStyle", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> templateStyle;
    @XmlElementRef(name = "TemplateType", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setBrandTemplateId(JAXBElement<String> value) {
        this.brandTemplateId = ((JAXBElement<String> ) value);
    }
    ...
    public void setEncoding(JAXBElement<String> value) {
        this.encoding = ((JAXBElement<String> ) value);
    }
    ...
    public void setHtmlValue(JAXBElement<String> value) {
        this.htmlValue = ((JAXBElement<String> ) value);
    }
    ...
    public void setTemplateStyle(JAXBElement<String> value) {
        this.templateStyle = ((JAXBElement<String> ) value);
    }
