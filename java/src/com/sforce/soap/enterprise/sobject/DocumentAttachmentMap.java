    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "DocumentId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> documentId;
    @XmlElementRef(name = "DocumentSequence", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setDocumentId(JAXBElement<String> value) {
        this.documentId = ((JAXBElement<String> ) value);
    }
    ...
    public void setDocumentSequence(JAXBElement<Integer> value) {
        this.documentSequence = ((JAXBElement<Integer> ) value);
    }
