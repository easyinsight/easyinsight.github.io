...
/**
 * <p>Java class for BrandTemplate complex type.
 * 
...
@XmlType(name = "BrandTemplate", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "description",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Value", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
