...
/**
 * <p>Java class for ContractContactRole complex type.
 * 
...
@XmlType(name = "ContractContactRole", propOrder = {
    "contact",
    "contactId",
    "contract",
    "contractId",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Contract", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Contract> contract;
    @XmlElementRef(name = "ContractId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
     ...
     *     
     */
    public void setContract(JAXBElement<Contract> value) {
        this.contract = ((JAXBElement<Contract> ) value);
    }
    ...
    public void setContractId(JAXBElement<String> value) {
        this.contractId = ((JAXBElement<String> ) value);
    }
