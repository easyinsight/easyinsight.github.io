...
/**
 * <p>Java class for AccountPartner complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="AccountFrom" type="{urn:sobject.enterprise.soap.sforce.com}Account" minOccurs="0"/>
 *         &lt;element name="AccountFromId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
 *         &lt;element name="AccountTo" type="{urn:sobject.enterprise.soap.sforce.com}Account" minOccurs="0"/>
 *         &lt;element name="AccountToId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
...
@XmlType(name = "AccountPartner", propOrder = {
    "accountFrom",
    "accountFromId",
    "accountTo",
    "accountToId",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "AccountFrom", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Account> accountFrom;
    @XmlElementRef(name = "AccountFromId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> accountFromId;
    @XmlElementRef(name = "AccountTo", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Account> accountTo;
    @XmlElementRef(name = "AccountToId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "IsPrimary", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Role", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setAccountFrom(JAXBElement<Account> value) {
        this.accountFrom = ((JAXBElement<Account> ) value);
    }
    ...
    public void setAccountFromId(JAXBElement<String> value) {
        this.accountFromId = ((JAXBElement<String> ) value);
    }
    ...
    public void setAccountTo(JAXBElement<Account> value) {
        this.accountTo = ((JAXBElement<Account> ) value);
    }
    ...
    public void setAccountToId(JAXBElement<String> value) {
        this.accountToId = ((JAXBElement<String> ) value);
    }
    ...
    public void setIsPrimary(JAXBElement<Boolean> value) {
        this.isPrimary = ((JAXBElement<Boolean> ) value);
    }
