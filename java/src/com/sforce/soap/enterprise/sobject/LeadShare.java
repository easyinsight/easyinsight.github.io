    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "LeadAccessLevel", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> leadAccessLevel;
     ...
     *     
     */
    public JAXBElement<String> getLeadAccessLevel() {
     ...
     *     
     */
    public void setLeadAccessLevel(JAXBElement<String> value) {
        this.leadAccessLevel = ((JAXBElement<String> ) value);
    }
