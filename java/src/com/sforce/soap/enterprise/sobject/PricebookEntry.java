    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Product2", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Product2> product2;
    @XmlElementRef(name = "Product2Id", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> product2Id;
    @XmlElementRef(name = "ProductCode", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "UseStandardPrice", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Boolean> useStandardPrice;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Product2 }{@code >}
     *     
     */
    public JAXBElement<Product2> getProduct2() {
        return product2;
    }
     ...
     *     
     */
    public void setProduct2(JAXBElement<Product2> value) {
        this.product2 = ((JAXBElement<Product2> ) value);
    }
     ...
     *     
     */
    public JAXBElement<String> getProduct2Id() {
        return product2Id;
    }
     ...
     *     
     */
    public void setProduct2Id(JAXBElement<String> value) {
        this.product2Id = ((JAXBElement<String> ) value);
    }
     ...
     *     
     */
    public JAXBElement<Boolean> getUseStandardPrice() {
     ...
     *     
     */
    public void setUseStandardPrice(JAXBElement<Boolean> value) {
        this.useStandardPrice = ((JAXBElement<Boolean> ) value);
    }
