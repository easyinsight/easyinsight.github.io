    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Solution", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Solution> solution;
    @XmlElementRef(name = "SolutionId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setSolution(JAXBElement<Solution> value) {
        this.solution = ((JAXBElement<Solution> ) value);
    }
    ...
    public void setSolutionId(JAXBElement<String> value) {
        this.solutionId = ((JAXBElement<String> ) value);
    }
