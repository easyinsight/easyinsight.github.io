...
/**
 * <p>Java class for NoteAndAttachment complex type.
 * 
 ...
 *         &lt;element name="IsNote" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlType(name = "NoteAndAttachment", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "isDeleted",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsNote", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Boolean> isNote;
    ...
    /**
     * Gets the value of the isNote property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public JAXBElement<Boolean> getIsNote() {
        return isNote;
    }

    /**
     * Sets the value of the isNote property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setIsNote(JAXBElement<Boolean> value) {
        this.isNote = ((JAXBElement<Boolean> ) value);
    }
    ...
    public void setParent(JAXBElement<Name> value) {
        this.parent = ((JAXBElement<Name> ) value);
    }
