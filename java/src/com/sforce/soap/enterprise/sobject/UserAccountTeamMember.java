...
/**
 * <p>Java class for UserAccountTeamMember complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UserAccountTeamMember">
 *   &lt;complexContent>
 ...
 *         &lt;element name="TeamMemberRole" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "UserAccountTeamMember", propOrder = {
    "accountAccessLevel",
    "caseAccessLevel",
    "createdBy",
    "createdById",
...
public class UserAccountTeamMember
    extends SObject
{

    @XmlElementRef(name = "AccountAccessLevel", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> accountAccessLevel;
    @XmlElementRef(name = "CaseAccessLevel", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "OpportunityAccessLevel", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "TeamMemberRole", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> teamMemberRole;
    @XmlElementRef(name = "User", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<User> user;
    @XmlElementRef(name = "UserId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
     ...
     *     
     */
    public JAXBElement<String> getAccountAccessLevel() {
     ...
     *     
     */
    public void setAccountAccessLevel(JAXBElement<String> value) {
        this.accountAccessLevel = ((JAXBElement<String> ) value);
    }
    ...
    public void setCaseAccessLevel(JAXBElement<String> value) {
        this.caseAccessLevel = ((JAXBElement<String> ) value);
    }
    ...
    public void setOpportunityAccessLevel(JAXBElement<String> value) {
        this.opportunityAccessLevel = ((JAXBElement<String> ) value);
    }
    ...
    /**
     * Gets the value of the teamMemberRole property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getTeamMemberRole() {
        return teamMemberRole;
    }

    /**
     * Sets the value of the teamMemberRole property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setTeamMemberRole(JAXBElement<String> value) {
        this.teamMemberRole = ((JAXBElement<String> ) value);
    }
