    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "AccessType", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "IsReadonly", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<Boolean> isReadonly;
    ...
    public void setAccessType(JAXBElement<String> value) {
        this.accessType = ((JAXBElement<String> ) value);
    }
     ...
     *     
     */
    public JAXBElement<Boolean> getIsReadonly() {
        return isReadonly;
    }
     ...
     *     
     */
    public void setIsReadonly(JAXBElement<Boolean> value) {
        this.isReadonly = ((JAXBElement<Boolean> ) value);
    }
