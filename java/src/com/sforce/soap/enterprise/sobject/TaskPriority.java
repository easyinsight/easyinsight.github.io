...
/**
 * <p>Java class for TaskPriority complex type.
 * 
...
@XmlType(name = "TaskPriority", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "isDefault",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsHighPriority", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setIsHighPriority(JAXBElement<Boolean> value) {
        this.isHighPriority = ((JAXBElement<Boolean> ) value);
    }
