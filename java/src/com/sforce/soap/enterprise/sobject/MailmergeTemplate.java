    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "Filename", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "LastUsedDate", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setLastUsedDate(JAXBElement<XMLGregorianCalendar> value) {
        this.lastUsedDate = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
