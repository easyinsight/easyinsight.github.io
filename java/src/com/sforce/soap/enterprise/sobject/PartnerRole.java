...
/**
 * <p>Java class for PartnerRole complex type.
 * 
...
@XmlType(name = "PartnerRole", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "lastModifiedBy",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "ReverseRole", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> reverseRole;
     ...
     *     
     */
    public JAXBElement<String> getReverseRole() {
        return reverseRole;
    }
     ...
     *     
     */
    public void setReverseRole(JAXBElement<String> value) {
        this.reverseRole = ((JAXBElement<String> ) value);
    }
