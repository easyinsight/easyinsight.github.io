...
/**
 * <p>Java class for CampaignMemberStatus complex type.
 * 
...
@XmlType(name = "CampaignMemberStatus", propOrder = {
    "campaignId",
    "createdBy",
    "createdById",
    "createdDate",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsDefault", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Label", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
