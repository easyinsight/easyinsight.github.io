    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "ApproveComment", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "RequestComment", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    ...
    public void setApproveComment(JAXBElement<String> value) {
        this.approveComment = ((JAXBElement<String> ) value);
    }
    ...
    public void setRequestComment(JAXBElement<String> value) {
        this.requestComment = ((JAXBElement<String> ) value);
    }
