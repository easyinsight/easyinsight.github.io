 ...
 *       &lt;sequence>
 *         &lt;element name="CategoryNodeId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
 ...
 *         &lt;element name="RelatedSobjectId" type="{urn:enterprise.soap.sforce.com}ID" minOccurs="0"/>
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "CategoryNodeId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> categoryNodeId;
    ...
    @XmlElementRef(name = "RelatedSobjectId", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<String> relatedSobjectId;
    @XmlElementRef(name = "SystemModstamp", namespace = "urn:sobject.enterprise.soap.sforce.com", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> systemModstamp;

    /**
     * Gets the value of the categoryNodeId property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getCategoryNodeId() {
        return categoryNodeId;
    }

    /**
     * Sets the value of the categoryNodeId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setCategoryNodeId(JAXBElement<String> value) {
        this.categoryNodeId = ((JAXBElement<String> ) value);
    }
    ...
    /**
     * Gets the value of the relatedSobjectId property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getRelatedSobjectId() {
        return relatedSobjectId;
    }

    /**
     * Sets the value of the relatedSobjectId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setRelatedSobjectId(JAXBElement<String> value) {
        this.relatedSobjectId = ((JAXBElement<String> ) value);
    }
