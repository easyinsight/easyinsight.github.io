 ...
 *
 */
public class HttpClient4Logger implements HttpClient {

    private org.apache.http.client.HttpClient client;

    public HttpClient4Logger() {
        client = new DefaultHttpClient();
    }

    public HttpClient4Logger(org.apache.http.client.HttpClient client) {
        this.client = client;
    }
