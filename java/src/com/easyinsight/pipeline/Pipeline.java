...
public abstract class Pipeline {
    ...
    public Pipeline setup(WSAnalysisDefinition report, Feed dataSource, InsightRequestMetadata insightRequestMetadata) {
        ...
        components = generatePipelineCommands(allNeededAnalysisItems);
        return this;
    }

    protected abstract List<IComponent> generatePipelineCommands(Set<AnalysisItem> allNeededAnalysisItems);
