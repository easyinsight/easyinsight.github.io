...
public class HighriseCustomFieldsCache extends HighRiseBaseSource {
    ...
    public void retrieveCustomFields(HttpClient client, String url, FeedDefinition parentDefinition, Date lastTime, HighriseCache highriseCache) throws HighRiseLoginException, ParsingException {
