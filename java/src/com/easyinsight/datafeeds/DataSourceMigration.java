...
public abstract class DataSourceMigration {
    ...
    protected void addConnection(ChildConnection childConnection, Connection conn) throws SQLException {
        ...
        CompositeFeedConnection connection = new CompositeFeedConnection(sourceDef.getDataFeedID(), targetDef.getDataFeedID(),
                sourceKey, targetKey, null, null, false, false, false, false);
    ...
    protected void addChildDataSource(FeedDefinition childDataSource, EIConnection conn) throws Exception {
        ...
        CompositeFeedNode compositeFeedNode = new CompositeFeedNode(childDataSource.getDataFeedID(), 50, 50, childDataSource.getFeedName(),
                childDataSource.getFeedType().getType(), childDataSource.getDataSourceBehavior());
