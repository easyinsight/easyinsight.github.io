...
public class KashooRecordSource extends KashooBaseSource {
    ...
    public static final String BUSINESS_ID = "Record - Business ID";
    public static final String TYPE = "Record Type";
    public static final String KEEP_IN_ORIGINAL_CURRENCY = "Record - Keep in Original Currency";
    public static final String EXCHANGE_PAYMENT = "Record - Exchange Payment";
    public static final String CURRENCY = "Record - Currency";
    public static final String DATE = "Record - Date";
    public static final String COLLABERATION_CONTEXT = "Record - Collaberation Context";
    public static final String TERMS = "Record - Terms";
    public static final String DEPOSIT_CURRENCY = "Record - Deposit Currency";
    public static final String REMOVED = "Record - Removed";
    public static final String BALANCE_DUE = "Record - Balance Due";
    public static final String DEPOSIT_ACCOUNT = "Record - Deposit Account";
    public static final String NUMBER = "Record - Number";
    public static final String AMOUNT = "Record - Amount";
    public static final String TOTAL_DUE = "Record - Total Due";
    public static final String CONTACT_NAME = "Record - Contact Name";
    public static final String ACCOUNT = "Record - Account";
    public static final String DUE_DATE = "Record - Due Date";
    public static final String CONTACT = "Record - Contact ID";
    public static final String MEMO = "Record - Memo";
    public static final String READ_ONLY = "Record - Read Only";
    public static final String PO_NUMBER = "Record - PO Number";
    ...
    public DataSet getDataSet(Map<String, Key> keys, Date now, FeedDefinition parentDefinition, IDataStorage IDataStorage, EIConnection conn, String callDataID, Date lastRefreshDate) throws ReportException {
        ...
        try {
            ...
            for(Object o : resp) {
                ...
                JSONArray responseObject = (JSONArray) runRestRequest("/api/businesses/" + businessID + "/records?limit=10", httpClient, parentDefinition, tokenObj.getTokenValue());
