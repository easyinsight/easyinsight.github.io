...
public interface IServerDataSourceDefinition {
    ...
    MigrationResult refreshData(long accountID, Date now, EIConnection conn, FeedDefinition parentDefinition, String callDataID, Date lastRefreshTime, boolean fullRefresh, List<ReportFault> warnings,
                                Map<String, Object> reportProperties) throws Exception;
