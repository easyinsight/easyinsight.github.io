 ...
 * Time: 10:03 PM
 */
public class DataSourceListener implements Runnable {

    private boolean running;

    private static DataSourceListener instance;

    public static DataSourceListener instance() {
        return instance;
    }
    ...
    public static void initialize() {
        instance = new DataSourceListener();
        //instance.executor = new ThreadPoolExecutor(1, 3, 5000, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>());
    ...
    public void blah() throws Exception {
        running = true;
        MessageQueue messageQueue = SQSUtils.connectToQueue(ConfigLoader.instance().getDataSourceRequestQueue(), "0AWCBQ78TJR8QCY8ABG2", "bTUPJqHHeC15+g59BQP8ackadCZj/TsSucNwPwuI");
        while (running) {
            try {
                ...
                if (message == null) {
                    ...
                    DataSourceThreadPool.instance().addActivity(() -> {
                        ...
                        try {
                            ...
                            try {
                                MessageQueue responseQueue = SQSUtils.connectToQueue(ConfigLoader.instance().getDataSourceResponseQueue(), "0AWCBQ78TJR8QCY8ABG2", "bTUPJqHHeC15+g59BQP8ackadCZj/TsSucNwPwuI");
                                if (e.getCause() == null) {
