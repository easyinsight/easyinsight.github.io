...
public class PivotalTrackerV5CompositeSource extends CompositeServerDataSource {
    ...
    protected Collection<ChildConnection> getChildConnections() {
        return Arrays.asList(new ChildConnection(FeedType.PIVOTAL_V5_PROJECT, FeedType.PIVOTAL_V5_EPIC, PivotalTrackerV5ProjectSource.ID, PivotalTrackerV5EpicSource.PROJECT_ID),
                ...
                new ChildConnection(FeedType.PIVOTAL_V5_EPIC, FeedType.PIVOTAL_V5_LABEL, PivotalTrackerV5EpicSource.LABEL_ID, PivotalTrackerV5LabelSource.ID, true),
                ...
                new ChildConnection(FeedType.PIVOTAL_V5_STORY_TO_LABEL, FeedType.PIVOTAL_V5_STORY, PivotalTrackerV5StoryToLabelSource.STORY_ID, PivotalTrackerV5StorySource.ID, true),
