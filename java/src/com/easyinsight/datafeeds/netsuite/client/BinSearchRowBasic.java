 ...
 *         &lt;element name="inactive" type="{urn:core_2014_1.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "BinSearchRowBasic", namespace = "urn:common_2014_1.platform.webservices.netsuite.com", propOrder = {
    "binNumber",
    "inactive",
    "internalId",
    "location",
