 ...
 *         &lt;element name="status" type="{urn:types.core_2014_1.platform.webservices.netsuite.com}AsyncStatusType"/>
...
@XmlType(name = "AsyncStatusResult", namespace = "urn:core_2014_1.platform.webservices.netsuite.com", propOrder = {
    "jobId",
    "status",
    "percentCompleted",
