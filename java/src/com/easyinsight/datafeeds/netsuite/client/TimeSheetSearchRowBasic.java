 ...
 *         &lt;element name="totalHours" type="{urn:core_2014_1.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "TimeSheetSearchRowBasic", namespace = "urn:common_2014_1.platform.webservices.netsuite.com", propOrder = {
    "approvalStatus",
    "employee",
    "endDate",
    "externalId",
