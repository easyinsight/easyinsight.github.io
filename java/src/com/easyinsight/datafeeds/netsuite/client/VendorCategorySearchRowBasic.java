 ...
 *         &lt;element name="isTaxAgency" type="{urn:core_2014_1.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "VendorCategorySearchRowBasic", namespace = "urn:common_2014_1.platform.webservices.netsuite.com", propOrder = {
    "externalId",
    "internalId",
    "isInactive",
    "isTaxAgency",
