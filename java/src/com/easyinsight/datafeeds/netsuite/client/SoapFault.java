 ...
 *       &lt;sequence>
 *         &lt;element name="code" type="{urn:types.faults_2014_1.platform.webservices.netsuite.com}FaultCodeType"/>
...
@XmlType(name = "SoapFault", namespace = "urn:faults_2014_1.platform.webservices.netsuite.com", propOrder = {
    "code",
    "message"
})
@XmlSeeAlso({
