...
public class RemoteRoleActors  implements java.io.Serializable {
    private com.easyinsight.datafeeds.jira.jiraweb.RemoteProjectRole projectRole;

    private com.easyinsight.datafeeds.jira.jiraweb.RemoteRoleActor[] roleActors;

    private com.easyinsight.datafeeds.jira.jiraweb.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           com.easyinsight.datafeeds.jira.jiraweb.RemoteProjectRole projectRole,
           com.easyinsight.datafeeds.jira.jiraweb.RemoteRoleActor[] roleActors,
           com.easyinsight.datafeeds.jira.jiraweb.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public com.easyinsight.datafeeds.jira.jiraweb.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(com.easyinsight.datafeeds.jira.jiraweb.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public com.easyinsight.datafeeds.jira.jiraweb.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(com.easyinsight.datafeeds.jira.jiraweb.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public com.easyinsight.datafeeds.jira.jiraweb.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.easyinsight.datafeeds.jira.jiraweb.RemoteUser[] users) {
        this.users = users;
    }
