...
public class RemotePermissionMapping  implements java.io.Serializable {
    private com.easyinsight.datafeeds.jira.jiraweb.RemotePermission permission;

    private com.easyinsight.datafeeds.jira.jiraweb.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           com.easyinsight.datafeeds.jira.jiraweb.RemotePermission permission,
           com.easyinsight.datafeeds.jira.jiraweb.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public com.easyinsight.datafeeds.jira.jiraweb.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(com.easyinsight.datafeeds.jira.jiraweb.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public com.easyinsight.datafeeds.jira.jiraweb.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(com.easyinsight.datafeeds.jira.jiraweb.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
