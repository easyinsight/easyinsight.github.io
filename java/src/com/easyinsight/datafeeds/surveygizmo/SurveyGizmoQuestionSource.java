...
public class SurveyGizmoQuestionSource extends SurveyGizmoBaseSource {
    ...
    protected void createFields(FieldBuilder fieldBuilder, Connection conn, FeedDefinition parentDefinition) {
        ...
        JSONObject doc = SurveyGizmoUtils.runRequest("/survey/" + formID + "/surveyquestion", httpClient, surveyGizmoCompositeSource, new ArrayList<NameValuePair>());
        ...
        for(Object o : data) {
            ...
            String type = (String) field.get("_subtype");
            if(!"instructions".equals(type)) {
