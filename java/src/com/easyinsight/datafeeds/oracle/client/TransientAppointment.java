...
public class TransientAppointment {
    ...
    @XmlElementRef(name = "ActivityName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> activityName;
    @XmlElementRef(name = "ActivityDescription", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> activityDescription;
    @XmlElementRef(name = "AsgnDenormFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> asgnDenormFlag;
    @XmlElementRef(name = "AsgnManualFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> asgnManualFlag;
    @XmlElementRef(name = "AsgnSystemFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> asgnSystemFlag;
    @XmlElementRef(name = "LockAsgnFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> lockAsgnFlag;
    @XmlElementRef(name = "DoNotRouteFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> doNotRouteFlag;
    @XmlElementRef(name = "OwnerId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> ownerId;
    @XmlElementRef(name = "OwnerRsrcOrgId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> ownerRsrcOrgId;
    @XmlElementRef(name = "SourceObjectCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sourceObjectCd;
    @XmlElementRef(name = "SourceObjectId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> sourceObjectId;
    @XmlElementRef(name = "TemplateId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> templateId;
    @XmlElementRef(name = "TemplateFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> templateFlag;
    @XmlElementRef(name = "PlannedStartDt", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> plannedStartDt;
    @XmlElementRef(name = "PlannedEndDt", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> plannedEndDt;
    @XmlElementRef(name = "PlannedDurationNumber", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> plannedDurationNumber;
    @XmlElementRef(name = "PlannedDurationUOMCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> plannedDurationUOMCd;
    @XmlElementRef(name = "ApptAlarmTmMinimumNumber", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> apptAlarmTmMinimumNumber;
    @XmlElementRef(name = "AlarmFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> alarmFlag;
    @XmlElementRef(name = "CustomerId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> customerId;
    @XmlElementRef(name = "ReferenceCustomerId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> referenceCustomerId;
    @XmlElementRef(name = "VisibilityCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> visibilityCd;
    @XmlElementRef(name = "RecurTypeCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recurTypeCd;
    @XmlElementRef(name = "RecurDay", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> recurDay;
    @XmlElementRef(name = "RecurMonth", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recurMonth;
    @XmlElementRef(name = "RecurPattern", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recurPattern;
    @XmlElementRef(name = "RecurExceptionFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurExceptionFlag;
    @XmlElementRef(name = "RecurWeekDayCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recurWeekDayCd;
    @XmlElementRef(name = "RecurWedFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurWedFlag;
    @XmlElementRef(name = "RecurTueFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurTueFlag;
    @XmlElementRef(name = "RecurThuFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurThuFlag;
    @XmlElementRef(name = "RecurSunFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurSunFlag;
    @XmlElementRef(name = "RecurSatFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurSatFlag;
    @XmlElementRef(name = "RecurReplaceCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recurReplaceCd;
    @XmlElementRef(name = "RecurMonFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurMonFlag;
    @XmlElementRef(name = "RecurFriFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurFriFlag;
    @XmlElementRef(name = "RecurFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> recurFlag;
    @XmlElementRef(name = "RecurOrigInstDt", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> recurOrigInstDt;
    @XmlElementRef(name = "RecurOccursNumber", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> recurOccursNumber;
    @XmlElementRef(name = "RecurFreqNumber", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> recurFreqNumber;
    @XmlElementRef(name = "RecurEndDt", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> recurEndDt;
    @XmlElementRef(name = "RecurApptId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> recurApptId;
    @XmlElementRef(name = "Response", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> response;
    @XmlElementRef(name = "ShowTimeAs", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> showTimeAs;
    @XmlElementRef(name = "CategoryCodeTransient", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> categoryCodeTransient;
    @XmlElementRef(name = "AllDayFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> allDayFlag;
    @XmlElementRef(name = "ActivityLocationTxt", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> activityLocationTxt;
    @XmlElementRef(name = "PartyName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> partyName;
    @XmlElementRef(name = "PartyId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> partyId;
    @XmlElementRef(name = "PartyName1", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> partyName1;
    @XmlElementRef(name = "PartyId1", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> partyId1;
    @XmlElementRef(name = "CustomerName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> customerName;
    @XmlElementRef(name = "Owner", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> owner;
    @XmlElementRef(name = "ConflictId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> conflictId;
    @XmlElementRef(name = "CreatedBy", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> createdBy;
    @XmlElementRef(name = "CreationDate", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> creationDate;
    @XmlElementRef(name = "LastUpdateDate", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> lastUpdateDate;
    @XmlElementRef(name = "LastUpdateLogin", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lastUpdateLogin;
    @XmlElementRef(name = "LastUpdatedBy", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lastUpdatedBy;
    @XmlElementRef(name = "ObjectVersionNumber", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> objectVersionNumber;
    @XmlElementRef(name = "EditMode", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> editMode;
    @XmlElementRef(name = "ReferenceCustomerName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    public void setPlannedDurationNumber(JAXBElement<BigDecimal> value) {
        this.plannedDurationNumber = value;
    }
    ...
    public void setPlannedDurationUOMCd(JAXBElement<String> value) {
        this.plannedDurationUOMCd = value;
    }
    ...
    public void setApptAlarmTmMinimumNumber(JAXBElement<Long> value) {
        this.apptAlarmTmMinimumNumber = value;
    }
    ...
    public void setCategoryCodeTransient(JAXBElement<String> value) {
        this.categoryCodeTransient = value;
    }
    ...
    public void setActivityLocationTxt(JAXBElement<String> value) {
        this.activityLocationTxt = value;
    }
    ...
    public void setReferenceCustomerName(JAXBElement<String> value) {
        this.referenceCustomerName = value;
    }
