...
public class RevenueTerritory {
    ...
    @XmlElementRef(name = "TerritoryVersionId", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ForecastParticipationCode", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> forecastParticipationCode;
    @XmlElementRef(name = "AssignmentType", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    ...
    public void setForecastParticipationCode(JAXBElement<String> value) {
        this.forecastParticipationCode = value;
    }
