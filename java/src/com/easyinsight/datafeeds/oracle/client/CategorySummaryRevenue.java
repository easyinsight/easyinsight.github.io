...
public class CategorySummaryRevenue {
    ...
    @XmlElementRef(name = "RevnCategoryCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PrimaryFlag", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> primaryFlag;
    @XmlElementRef(name = "CrmCurcyCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> crmCurcyCode;
    @XmlElementRef(name = "CrmConversionRateType", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> crmConversionRateType;
    @XmlElementRef(name = "CrmConversionRate", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "CrmCategorySummaryRevenue", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    ...
    public void setCrmCategorySummaryRevenue(JAXBElement<BigDecimal> value) {
        this.crmCategorySummaryRevenue = value;
    }
