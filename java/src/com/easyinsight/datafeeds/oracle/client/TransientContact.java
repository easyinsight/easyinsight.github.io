...
public class TransientContact {
    ...
    @XmlElementRef(name = "ActivityContactId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> activityContactId;
    @XmlElementRef(name = "ContactId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ContactRelationshipId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PartyType", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> partyType;
    @XmlElementRef(name = "PersonFirstName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> personFirstName;
    @XmlElementRef(name = "PersonMiddleName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> personMiddleName;
    @XmlElementRef(name = "PersonLastName", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> personLastName;
    @XmlElementRef(name = "PersonTitle", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
