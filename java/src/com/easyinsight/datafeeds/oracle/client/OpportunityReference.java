...
public class OpportunityReference {
    ...
    @XmlElementRef(name = "ReferenceRankNumber", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "DUNSNumberC", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dunsNumberC;
    @XmlElementRef(name = "Comments1", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "IntContactPartyId", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> intContactPartyId;
    @XmlElement(name = "PartyName2")
    protected String partyName2;
    @XmlElementRef(name = "CustomerContactRelationId", namespace = "http://xmlns.oracle.com/apps/sales/opptyMgmt/opportunities/opportunityService/", type = JAXBElement.class, required = false)
    ...
    public void setReferenceRankNumber(JAXBElement<String> value) {
        this.referenceRankNumber = value;
    }
    ...
    public void setCustomerContactRelationId(JAXBElement<Long> value) {
        this.customerContactRelationId = value;
    }
