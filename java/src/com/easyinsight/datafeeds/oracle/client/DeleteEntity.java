...
public class DeleteEntity {
    ...
    @XmlElementRef(name = "EntitySequenceNumber", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> entitySequenceNumber;
    @XmlElementRef(name = "DeleteEntityType", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> deleteEntityType;
    @XmlElementRef(name = "Pk1Value", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> pk1Value;
    @XmlElementRef(name = "Pk2Value", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> pk2Value;
    @XmlElementRef(name = "Pk3Value", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> pk3Value;
    @XmlElementRef(name = "Pk4Value", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> pk4Value;
    @XmlElementRef(name = "Pk5Value", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> pk5Value;
    @XmlElementRef(name = "DeleteStatusType", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> deleteStatusType;
    @XmlElementRef(name = "DeleteDate", namespace = "http://xmlns.oracle.com/apps/scm/productModel/deleteGroups/publicModel/", type = JAXBElement.class, required = false)
    ...
    public void setEntitySequenceNumber(JAXBElement<Long> value) {
        this.entitySequenceNumber = value;
    }
