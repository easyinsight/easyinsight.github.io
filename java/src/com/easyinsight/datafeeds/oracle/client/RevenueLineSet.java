...
@XmlType(name = "RevenueLineSet", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", propOrder = {
    "revnId",
    "revnLineTypeCode",
    "revnSequenceNumber",
    "optyId",
...
public class RevenueLineSet {
    ...
    @XmlElementRef(name = "RevnLineTypeCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> revnLineTypeCode;
    @XmlElementRef(name = "RevnSequenceNumber", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> revnSequenceNumber;
    @XmlElementRef(name = "OptyId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> optyId;
    @XmlElementRef(name = "BUOrgId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> buOrgId;
    @XmlElementRef(name = "CustomerPartyId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> customerPartyId;
    @XmlElementRef(name = "CustomerAccountId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> customerAccountId;
    @XmlElementRef(name = "OwnerResourceId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> ownerResourceId;
    @XmlElementRef(name = "OwnerResourceOrgId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> ownerResourceOrgId;
    @XmlElementRef(name = "OwnerOrgTreeStructCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ownerOrgTreeStructCode;
    @XmlElementRef(name = "OwnerOrgTreeCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ownerOrgTreeCode;
    @XmlElementRef(name = "EffectiveDate", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> effectiveDate;
    @XmlElementRef(name = "ProdGroupId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> prodGroupId;
    @XmlElementRef(name = "RevnAmountCurcyCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> revnAmountCurcyCode;
    @XmlElementRef(name = "RevnAmount", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<AmountType> revnAmount;
    @XmlElementRef(name = "StatusCode", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "LastUpdateLogin", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lastUpdateLogin;
    @XmlElement(name = "ObjectVersionNumber")
    protected Integer objectVersionNumber;
    @XmlElementRef(name = "UserLastUpdateDate", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> userLastUpdateDate;
    @XmlElement(name = "ProdGroupName")
    protected String prodGroupName;
    @XmlElementRef(name = "SalesAccountId", namespace = "http://xmlns.oracle.com/oracle/apps/sales/opptyMgmt/revenues/revenueService/", type = JAXBElement.class, required = false)
