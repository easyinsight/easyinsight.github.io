...
@XmlType(name = "TransientAssignee", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", propOrder = {
    "activityAssigneeId",
    "assigneeId",
    "activityId",
    "assigneeRsrcOrgId",
...
public class TransientAssignee {
    ...
    @XmlElementRef(name = "ActivityAssigneeId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> activityAssigneeId;
    @XmlElementRef(name = "AssigneeId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "AssigneeRsrcOrgId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ShowTimeAsCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> showTimeAsCd;
    @XmlElementRef(name = "AppointmentResponseCd", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> appointmentResponseCd;
    @XmlElementRef(name = "OwnerFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    public void setAppointmentResponseCd(JAXBElement<String> value) {
        this.appointmentResponseCd = value;
    }
