...
public class TransientNote {
    ...
    @XmlElementRef(name = "NoteId", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SourceObjectCode", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sourceObjectCode;
    @XmlElementRef(name = "NoteTypeCode", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> noteTypeCode;
    @XmlElementRef(name = "NoteTxt", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> noteTxt;
    @XmlElementRef(name = "VisibilityCode", namespace = "http://xmlns.oracle.com/apps/crmCommon/activities/activitiesService/", type = JAXBElement.class, required = false)
