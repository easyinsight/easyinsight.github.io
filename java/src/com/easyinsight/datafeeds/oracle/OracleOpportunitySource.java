...
public class OracleOpportunitySource extends OracleBaseSource {
	...
	protected void createFields(FieldBuilder fieldBuilder, Connection conn, FeedDefinition parentDefinition) {
        fieldBuilder.addField(BUDGETAVAILABLEDATE, new AnalysisDateDimension());
		...
		fieldBuilder.addField(REVENUE, new AnalysisMeasure());
		...
		fieldBuilder.addField(CURRENTFYPOTENTIALREVENUE, new AnalysisMeasure());
		...
		fieldBuilder.addField(LASTASSIGNEDDATE, new AnalysisDateDimension());
		fieldBuilder.addField(LOOKUPCATEGORY, new AnalysisDimension());
		fieldBuilder.addField(LOOKUPVALUESID, new AnalysisDimension());
		fieldBuilder.addField(OPTYCREATIONDATE, new AnalysisDateDimension());
		...
		fieldBuilder.addField(CRMREVENUE, new AnalysisMeasure());
		fieldBuilder.addField(PARTYTYPE, new AnalysisDimension());
		fieldBuilder.addField(OPTYLASTUPDATEDATE, new AnalysisDateDimension());
		...
		fieldBuilder.addField(LASTASSIGNEDTIMESTAMP, new AnalysisDateDimension());
	}
