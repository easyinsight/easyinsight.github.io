...
public class OracleRevenueSource extends OracleBaseSource {
	public OracleRevenueSource() {
        setFeedName("Revenue");
    }
	...
	public static final String RECURPERIODORENDDATECODE = "RecurPeriodOrEndDateCode";
	public static final String ACTUALCLOSEDATE = "ActualCloseDate";
	public static final String ATTACHMENTENTITYNAME = "AttachmentEntityName";
	...
	public static final String NQSPLITALLOCTYPECODE = "NqSplitAllocTypeCode";
	...
	public static final String REVNCREATIONDATE = "RevnCreationDate";
	...
	public static final String PRPARTORGPARTYID = "PrPartOrgPartyId";
	public static final String PARTENGAGEMENTTYPECD = "PartEngagementTypeCd";
	...
	public static final String PARTORGPARTYNAME = "PartOrgPartyName";
	public static final String PARENTREVNID = "ParentRevnId";
	...
	protected void createFields(FieldBuilder fieldBuilder, Connection conn, FeedDefinition parentDefinition) {		fieldBuilder.addField(REVNID, new AnalysisDimension());
		...
		fieldBuilder.addField(RECURPERIODORENDDATECODE, new AnalysisDimension());
		fieldBuilder.addField(ACTUALCLOSEDATE, new AnalysisDateDimension(true));
		fieldBuilder.addField(ATTACHMENTENTITYNAME, new AnalysisDimension());
		...
		fieldBuilder.addField(ITEMNUMBER, new AnalysisDimension());
		fieldBuilder.addField(OPTYNUMBER, new AnalysisDimension());
		fieldBuilder.addField(PRODUCTTYPE, new AnalysisDimension());
		fieldBuilder.addField(NQSPLITALLOCTYPECODE, new AnalysisDimension());
		...
		fieldBuilder.addField(REVNCREATIONDATE, new AnalysisDateDimension(true));
		fieldBuilder.addField(REVNCATEGORYCODE, new AnalysisDimension());
		fieldBuilder.addField(OPTYLEADID, new AnalysisDimension());
		fieldBuilder.addField(SALESCHANNELCD, new AnalysisDimension());
		fieldBuilder.addField(PRPARTORGPARTYID, new AnalysisDimension());
		fieldBuilder.addField(PARTENGAGEMENTTYPECD, new AnalysisDimension());
		...
		fieldBuilder.addField(PARTORGPARTYNAME, new AnalysisDimension());
		fieldBuilder.addField(PARENTREVNID, new AnalysisDimension());
...
@Override
	...
	try {
		...
		List<com.easyinsight.datafeeds.oracle.client.Revenue> list = oracleDataSource.getChildRevenue();
		for (com.easyinsight.datafeeds.oracle.client.Revenue o : list) {
		...
		row.addValue(keys.get(RECURPERIODORENDDATECODE), o.getRecurPeriodOrEndDateCode().getValue());
		row.addValue(keys.get(ACTUALCLOSEDATE), getDate(o.getActualCloseDate()));
		row.addValue(keys.get(ATTACHMENTENTITYNAME), o.getAttachmentEntityName().getValue());
		...
		row.addValue(keys.get(ITEMNUMBER), o.getItemNumber().getValue());
		row.addValue(keys.get(OPTYNUMBER), o.getOptyNumber());
		row.addValue(keys.get(PRODUCTTYPE), o.getProductType().getValue());
		row.addValue(keys.get(NQSPLITALLOCTYPECODE), o.getNqSplitAllocTypeCode().getValue());
		...
		row.addValue(keys.get(REVNCREATIONDATE), getDate(o.getRevnCreationDate()));
		row.addValue(keys.get(REVNCATEGORYCODE), o.getRevnCategoryCode().getValue());
		row.addValue(keys.get(OPTYLEADID), String.valueOf(o.getOptyLeadId().getValue()));
		row.addValue(keys.get(SALESCHANNELCD), o.getSalesChannelCd().getValue());
		row.addValue(keys.get(PRPARTORGPARTYID), String.valueOf(o.getPrPartOrgPartyId().getValue()));
		row.addValue(keys.get(PARTENGAGEMENTTYPECD), o.getPartEngagementTypeCd().getValue());
		...
		row.addValue(keys.get(PARTORGPARTYNAME), o.getPartOrgPartyName());
		row.addValue(keys.get(PARENTREVNID), String.valueOf(o.getParentRevnId().getValue()));
		...
		row.addValue(keys.get(PARTYUNIQUENAME1), o.getPartyUniqueName1());
		}
    ...
    public FeedType getFeedType() {
        return FeedType.ORACLE_REVENUE;
    }
