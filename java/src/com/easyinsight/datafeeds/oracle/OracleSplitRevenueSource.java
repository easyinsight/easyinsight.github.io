...
public class OracleSplitRevenueSource extends OracleBaseSource {
	...
	protected void createFields(FieldBuilder fieldBuilder, Connection conn, FeedDefinition parentDefinition) {		fieldBuilder.addField(TARGETPARTYID, new AnalysisDimension());
		...
		fieldBuilder.addField(OWNERDEALEXPIRATIONDATE, new AnalysisDateDimension(true));
		fieldBuilder.addField(OWNERDEALPROTECTEDDATE, new AnalysisDateDimension(true));
		fieldBuilder.addField(NAME, new AnalysisDimension());
		fieldBuilder.addField(EFFECTIVESTARTDATE, new AnalysisDateDimension(true));
		fieldBuilder.addField(EFFECTIVEENDDATE, new AnalysisDateDimension(true));
