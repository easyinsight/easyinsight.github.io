...
public class FeedStorage {
    ...
    public long addFeedDefinitionData(FeedDefinition feedDefinition, Connection conn) throws Exception {
        ...
        insertDataFeedStmt = conn.prepareStatement("INSERT INTO DATA_FEED (FEED_NAME, FEED_TYPE, PUBLICLY_VISIBLE, FEED_SIZE, " +
                ...
                "manual_report_run, default_tag_id, visible_within_parent_configuration, default_to_full_joins, default_to_optimized, " +
                        "avoid_key_display_collisions, auto_combined, field_renames) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
        ...
        insertDataFeedStmt.setBoolean(i, feedDefinition.isFieldRenames());
    ...
    public void updateDataFeedConfiguration(FeedDefinition feedDefinition, EIConnection conn, int overrideType) throws Exception {
        ...
        updateDataFeedStmt.setBoolean(i++, feedDefinition.isFieldRenames());
    ...
    public FeedDefinition getFeedDefinitionData(long identifier, Connection conn, boolean cache) throws SQLException {
        ...
        PreparedStatement queryFeedStmt = conn.prepareStatement("SELECT FEED_NAME, FEED_TYPE, PUBLICLY_VISIBLE, MARKETPLACE_VISIBLE, CREATE_DATE," +
                ...
                "default_to_optimized, avoid_key_display_collisions, auto_combined, field_renames FROM DATA_FEED WHERE " +
                "DATA_FEED_ID = ?");
        ...
        if (rs.next()) {
            ...
            feedDefinition.setFieldRenames(rs.getBoolean(i));
