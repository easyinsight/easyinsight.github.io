...
public class CacheDataTransform implements IDataTransform {
    ...
    public void handle(EIConnection conn, IRow row) {
        ...
        List<AnalysisItem> items = ReportCalculation.getAnalysisItems(calculation.getCalculationString(), allItems, keyMap, displayMap, displayMap, new ArrayList<AnalysisItem>(),
        ...
        boolean hasProvider = calculation.getCalculationString().contains("Provider");
        if (hasProvider) {
            for (AnalysisItem analysisItem : allItems) {
