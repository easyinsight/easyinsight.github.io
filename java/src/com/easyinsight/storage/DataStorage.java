    ...
    public void insertFromSelect(String tempTable) throws SQLException {
        if (database.getDialect() == Database.MYSQL) {
            ...
            try {
                ...
                String string = "copy " + getTableName() + " (" + sb.toString() + ") from 's3://" + bucketName + "/" + tempTable + "' credentials 'aws_access_key_id=0AWCBQ78TJR8QCY8ABG2;aws_secret_access_key=bTUPJqHHeC15+g59BQP8ackadCZj/TsSucNwPwuI' delimiter '|' GZIP timeformat 'YYYY-MM-DD HH:MI:SS'";
    ...
    public void updateFromTemp(String tempTable, Key updateKey) throws SQLException {
        ...
        if (database.getDialect() == Database.MYSQL) {
            ...
            try {
                ...
                sb.deleteCharAt(sb.length() - 1);
                String string = "copy " + loadTable + " ("+sb.toString()+") from 's3://"+bucketName+"/"+tempTable+"' credentials 'aws_access_key_id=0AWCBQ78TJR8QCY8ABG2;aws_secret_access_key=bTUPJqHHeC15+g59BQP8ackadCZj/TsSucNwPwuI' delimiter '|' GZIP timeformat 'YYYY-MM-DD HH:MI:SS'";
                System.out.println(string);
                PreparedStatement stmt = storageConn.prepareStatement(string);
                stmt.execute();
            } finally {
