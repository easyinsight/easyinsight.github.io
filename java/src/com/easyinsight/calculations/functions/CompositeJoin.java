 ...
 * Time: 3:42 PM
 */
public class CompositeJoin extends Function {
    public Value evaluate() {
        ...
        compositeCalculationMetadata.getJoins().add(new CompositeFeedCompositeConnection(pairs, dataSource1, dataSource2));
        return null;
    }
