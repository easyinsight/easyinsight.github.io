    ...
    public void addKPIData(SolutionKPIData solutionKPIData) {
        ...
        try {
            ...
            if (!autoSetupDeliveries.isEmpty()) {
                ...
                generalDelivery.setBody("This weekly update of your " + dataSource.getFeedName() + " stats was automatically generated by Easy Insight. You can add additional reports, change the reports selected, or turn this email off entirely from the Scheduling page in Easy Insight.");
