...
public class AsyncReport {
    ...
    public void assign() {
        ...
        try {
            ...
            stmt.close();
            PreparedStatement workStmt = conn.prepareStatement("SELECT async_report_request_id, assigned_server, request_state FROM async_report_request use index (async_report_request_idx2) WHERE request_state = ? OR request_state = ? OR request_state = ?");
