...
public class RollingFilterDefinition extends FilterDefinition {
    ...
    public static List<CustomRollingInterval> createAdditionalIntervals() {
        ...
        additionalIntervals.add(createInterval(MaterializedRollingFilterDefinition.PREVIOUS_FULL_WEEK, "Previous Full Week", "dayofweek(now() - weeks(2), 1)", "dayofweek(now() - weeks(2), 7))"));
        ...
        additionalIntervals.add(createInterval(MaterializedRollingFilterDefinition.LAST_WEEK_TO_NOW, "Last Week to Now", "dayofweek(now() - weeks(1), firstdayofweek())", "dayofweek(now() - weeks(1), dayofweek(now()))"));
        ...
        additionalIntervals.add(createInterval(MaterializedRollingFilterDefinition.NEXT_FULL_WEEK, "Next Full Week", "dayofweek(now() + weeks(1), 1)", "dayofweek(now() + weeks(1), 7)"));
