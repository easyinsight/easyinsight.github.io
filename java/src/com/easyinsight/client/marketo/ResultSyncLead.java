 ...
 *         &lt;element name="syncStatus" type="{http://www.marketo.com/mktows/}LeadSyncStatus"/>
...
public class ResultSyncLead {
    ...
    protected LeadSyncStatus syncStatus;
     ...
     *     
     */
    public LeadSyncStatus getSyncStatus() {
        return syncStatus;
    }
     ...
     *     
     */
    public void setSyncStatus(LeadSyncStatus value) {
