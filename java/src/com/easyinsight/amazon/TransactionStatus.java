...
public class TransactionStatus implements java.io.Serializable {
    ...
    public static final TransactionStatus Reserved = new TransactionStatus(_Reserved);
    public static final TransactionStatus Success = new TransactionStatus(_Success);
    public static final TransactionStatus Failure = new TransactionStatus(_Failure);
    public static final TransactionStatus Initiated = new TransactionStatus(_Initiated);
    public static final TransactionStatus Reinitiated = new TransactionStatus(_Reinitiated);
    public static final TransactionStatus TemporaryDecline = new TransactionStatus(_TemporaryDecline);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fps.amazonaws.com/doc/2007-01-08/", "TransactionStatus"));
    }
    /**
