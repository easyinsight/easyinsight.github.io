...
public class ErrorType implements java.io.Serializable {
    ...
    public static final ErrorType System = new ErrorType(_System);
    public static final ErrorType Business = new ErrorType(_Business);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fps.amazonaws.com/doc/2007-01-08/", "ErrorType"));
    }
    /**
