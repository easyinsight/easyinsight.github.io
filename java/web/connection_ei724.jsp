...
if ( hasProductInstall && !hasRequestedVersion ) {
	...
	AC_FL_RunContent(
			"src", "<%=versionDir%>/ConnectionApplication",
			"width", "100%",
			"height", "100%",
			"align", "middle",
			"id", "ConnectionApplication",
...
<noscript>
    <h1 style="display:none">Easy Insight Application</h1>
  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			id="ConnectionApplication" width="100%" height="100%"
			codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
			<param name="movie" value="ConnectionApplication.swf" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#ffffff" />
			<param name="allowScriptAccess" value="sameDomain" />
            <param name="allowFullScreen" value="true" />
			<embed src="<%= versionDir%>/ConnectionApplication.swf" quality="high" bgcolor="#ffffff"
				width="100%" height="100%" name="ConnectionApplication" align="middle"
				play="true"
				loop="false"
				quality="high"
				allowScriptAccess="sameDomain"
