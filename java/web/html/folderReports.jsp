...
<%
    ...
    try {
        ...
        boolean additionalViews = "AdditionalViews".equals(folderIDString);
        String folderName = "";
        long folderID = 0;
        if (!additionalViews) {
            ...
            try {
                PreparedStatement ps = conn.prepareStatement("SELECT FOLDER_NAME FROM REPORT_FOLDER WHERE REPORT_FOLDER_ID = ?");
...
<div class="container">
    <div class="row">
        <ul class="breadcrumb">
            ...
            <li class="active"><%= StringEscapeUtils.escapeHtml(folderName)%></li>
        </ul>
    </div>
</div>
<div class="container">
