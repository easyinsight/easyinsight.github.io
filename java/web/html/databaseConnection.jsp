...
<div class="container corePageWell" style="margin-top: 20px">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <p style="font-size: 12px">You can download a Java web application to run behind your firewall and publish the data out to Easy Insight. This web application can run in any standard Java servlet container. The web application can be downloaded <a href="">here.</a></p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <p style="font-size: 12px">You can also directly connect Easy Insight to your database by granting firewall permissions to a fixed IP of db.easy-insight.com (107.21.250.229) with the configuration form below.</p>
        </div>
    </div>
    <%
...
%>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <p style="font-size: 12px">For the server side database connection to work, you'll need to open up your firewall to allow access on the database port to db.easy-insight.com (107.21.250.229). If you can't allow access through the firewall, you'll need to download and use the alternate database connection, hosting that behind your firewall. If you're running on the Amazon Web Services cloud, the configuration will be a little different--please contact us at support@easy-insight.com or 1-720-316-8174 and we'll work with you to complete setup.</p>
            <hr>
            <p style="font-size: 12px">The query defines what fields and data to pull back into Easy Insight. For example, you might do 'select * from table_name', 'select a, b from table_name' or 'select a as A, b as B from table_name where X = Y'.</p>
        </div>
