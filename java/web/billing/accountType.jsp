                ...
                <div style="background-color: #F0F0F0;padding: 8px">
                    ...
                    <div class="row" style="padding-top: 20px;text-align: center">
                            ...
                            <div class="span4" style="background-color:#FFFFFF;padding: 10px;text-align: left">
                                ...
                                <input type="text" style="width:290px" name="numberDesigners"
                                ...
                                <input type="text" style="width:290px" name="numberConnections"
                                ...
                                <input type="text" style="width:290px" name="numberStorageBlocks"
