...
<%
    ...
    try {
        ...
        if (SecurityUtil.getAccountTier() < Account.PREMIUM) {
            response.sendRedirect(RedirectUtil.getURL(request, "/app/billing/newModelBilling.jsp"));
            return;
        }
        ...
        try {
            ...
            cost = account.getEnterpriseAddonCost();
        } finally {
        ...
        String trData = new BrainTreeBlueBillingSystem().getEnterpriseRedirect(trParams);
        ...
        billingMessage = "You are signing up for an Easy Insight subscription. You will be charged " + NumberFormat.getCurrencyInstance().format(cost) + " USD " + ("monthly") + " for your subscription.";
