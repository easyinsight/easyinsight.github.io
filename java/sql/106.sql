...
create table user_to_data_source_notification (
  ...
  key(feed_id),
  constraint user_to_data_source_notification_ibfk1 foreign key (notification_id) references notification_base(notification_id),
...
create table user_to_report_notification (
  ...
  key(notification_id),
  key(analysis_id),
  constraint user_to_report_notification_ibfk1 foreign key (notification_id) references notification_base(notification_id),
