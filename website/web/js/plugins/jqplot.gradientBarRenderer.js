...
(function ($) {
    ...
    $.jqplot.GradientBarRenderer.prototype = new $.jqplot.LineRenderer();
    $.jqplot.GradientBarRenderer.prototype.constructor = $.jqplot.GradientBarRenderer;

    // called with scope of series.
    $.jqplot.GradientBarRenderer.prototype.init = function (options, plot) {
        // Group: Properties
        //
        // prop: barPadding
    ...
    $.jqplot.GradientBarRenderer.prototype.calcSeriesNumbers = function () {
        var nvals = 0;
        var nseries = 0;
        ...
        for (var i = 0; i < paxis._series.length; i++) {
            ...
            if (series.renderer.constructor == $.jqplot.GradientBarRenderer) {
    ...
    $.jqplot.GradientBarRenderer.prototype.setBarWidth = function () {
...
//                        c = [{"point": 0, "color": c}, {"point":.5, "color": c}, {"point": 1, "color": c}]
    ...
    $.jqplot.GradientBarRenderer.prototype.draw = function (ctx, gridData, options) {
        var i;
        ...
        if (showLine) {
            var negativeColors = new $.jqplot.ColorGenerator(this.negativeSeriesColors, ctx);
            var positiveColors = new $.jqplot.ColorGenerator(this.seriesColors, ctx);
    ...
    $.jqplot.GradientBarRenderer.prototype.drawShadow = function (ctx, gridData, options) {
        var i;
    ...
    function postInit(target, data, options) {
        for (var i = 0; i < this.series.length; i++) {
            if (this.series[i].renderer.constructor == $.jqplot.GradientBarRenderer) {
