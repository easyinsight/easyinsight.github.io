     ...
     private function onMouseDown(event:MouseEvent):void {
	    ...
	    /** @private */
 		public function newComponent(item: Item): UIComponent {
             ...
             if (item.initialX > 0) {
                 component.x = item.initialX;
                 component.y = item.initialY;
             } else {
