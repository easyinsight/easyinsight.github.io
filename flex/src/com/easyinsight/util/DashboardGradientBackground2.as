...
public class DashboardGradientBackground2 extends HaloBorder {
    public function DashboardGradientBackground2() {
        super();
    }
    ...
    override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
    {
        ...
        GraphicsUtil.drawRoundRectComplex(g, b.left, b.top, w, h, 0, 0, 0, 0);
        g.endFill();
