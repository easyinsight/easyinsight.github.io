...
public class AutoCompleteFilter extends HBox implements IFilter {
    ...
    private var completion:AutoCompleteManager;
    ...
    override protected function createChildren():void {
        ...
        if (textInput == null) {
            ...
            completion = new AutoCompleteManager();
            completion.target = textInput;
            completion.minCharsForCompletion = 1;
            completion.addEventListener(Event.CLOSE, filterValueChanged);
    ...
    private function filterValueChanged(event:Event):void {
    ...
    private function gotMetadata(event:ResultEvent):void {
        ...
        if (_filterDefinition == null) {
            ...
            _filterDefinition.autoComplete = true;
        }
        ...
        if (_filterDefinition.filteredValues.length > 0) {
            ...
            textInput.text = selectedValue;
        }

        textInput.enabled = _filterDefinition.enabled;
        if (deleteButton != null) {
