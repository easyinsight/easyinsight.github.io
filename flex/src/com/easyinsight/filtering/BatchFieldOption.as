...
[Bindable]
public class BatchFieldOption extends EventDispatcher {
    ...
    public function BatchFieldOption(analysisItem:AnalysisItem, selected:Boolean = false) {
        this.analysisItem = analysisItem;
        _label = analysisItem.display;
