...
public class EmbeddedLastValueFilter extends HBox implements IEmbeddedFilter {
    public function EmbeddedLastValueFilter(feedID:int, analysisItem:AnalysisItem) {
        super();
