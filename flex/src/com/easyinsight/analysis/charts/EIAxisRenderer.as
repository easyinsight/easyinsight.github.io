...
public class EIAxisRenderer extends DualStyleObject implements IAxisRenderer {
     ...
     *  Constructor.
     */
    public function EIAxisRenderer()
    {
        super();
        ...
        if (showLine == true)
        {
            ...
            if (_horizontal && _otherAxes)
            {
                for (var i:int = 0; i < _otherAxes.length; i++)
                {
                    ...
                    if(otherAxis is EIAxisRenderer)
                    {
                        otherLineStyle = EIAxisRenderer(otherAxis).getStyle("axisStroke");
                        otherShowLine = EIAxisRenderer(otherAxis).getStyle("showLine");
                    }
