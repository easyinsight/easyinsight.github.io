 ...
 */
public class EIWedgeItemRenderer extends UIComponent implements IDataRenderer
{
	 ...
	 *  Constructor.
	 */
	public function EIWedgeItemRenderer()
	{
		super();
	}
    ...
    private function onDrilldown(event:ContextMenuEvent):void {
        dispatchEvent(new ChartDrilldownEvent(ChartDrilldownEvent.DRILLDOWN, _wedge as ChartItem));
    }

    private function onRollup(event:ContextMenuEvent):void {
        dispatchEvent(new ChartDrilldownEvent(ChartDrilldownEvent.ROLLUP, _wedge as ChartItem));
    }
