...
import com.easyinsight.genredata.AnalyzeEvent;
	...
	public class DelayedScorecardViewLink extends EventDispatcher
	{
		private var scorecardService:RemoteObject;
		private var scorecardID:String;
		
		public function DelayedScorecardViewLink(dashboardID:String)
		{
        ...
        private function gotGoalTree(event:ResultEvent):void {
            ...
            if (result > 0) {
                dispatchEvent(new AnalyzeEvent(new PerspectiveInfo(PerspectiveInfo.SCORECARD_VIEW, {scorecardID: result})))
            }
        }
	}
}