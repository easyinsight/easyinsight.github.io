...
public class Row  implements java.io.Serializable {
    private com.easyinsight.solutions.teamcity.webservice.DatePair[] datePairs;

    private com.easyinsight.solutions.teamcity.webservice.NumberPair[] numberPairs;

    private com.easyinsight.solutions.teamcity.webservice.StringPair[] stringPairs;

    public Row() {
    }

    public Row(
           com.easyinsight.solutions.teamcity.webservice.DatePair[] datePairs,
           com.easyinsight.solutions.teamcity.webservice.NumberPair[] numberPairs,
           com.easyinsight.solutions.teamcity.webservice.StringPair[] stringPairs) {
     ...
     * @return datePairs
     */
    public com.easyinsight.solutions.teamcity.webservice.DatePair[] getDatePairs() {
        return datePairs;
    }
     ...
     * @param datePairs
     */
    public void setDatePairs(com.easyinsight.solutions.teamcity.webservice.DatePair[] datePairs) {
        this.datePairs = datePairs;
    }

    public com.easyinsight.solutions.teamcity.webservice.DatePair getDatePairs(int i) {
        return this.datePairs[i];
    }

    public void setDatePairs(int i, com.easyinsight.solutions.teamcity.webservice.DatePair _value) {
     ...
     * @return numberPairs
     */
    public com.easyinsight.solutions.teamcity.webservice.NumberPair[] getNumberPairs() {
        return numberPairs;
    }
     ...
     * @param numberPairs
     */
    public void setNumberPairs(com.easyinsight.solutions.teamcity.webservice.NumberPair[] numberPairs) {
        this.numberPairs = numberPairs;
    }

    public com.easyinsight.solutions.teamcity.webservice.NumberPair getNumberPairs(int i) {
        return this.numberPairs[i];
    }

    public void setNumberPairs(int i, com.easyinsight.solutions.teamcity.webservice.NumberPair _value) {
     ...
     * @return stringPairs
     */
    public com.easyinsight.solutions.teamcity.webservice.StringPair[] getStringPairs() {
        return stringPairs;
    }
     ...
     * @param stringPairs
     */
    public void setStringPairs(com.easyinsight.solutions.teamcity.webservice.StringPair[] stringPairs) {
        this.stringPairs = stringPairs;
    }

    public com.easyinsight.solutions.teamcity.webservice.StringPair getStringPairs(int i) {
        return this.stringPairs[i];
    }

    public void setStringPairs(int i, com.easyinsight.solutions.teamcity.webservice.StringPair _value) {
