...
public class Where  implements java.io.Serializable {
    ...
    private com.easyinsight.dbservice.validated.DayWhere[] dayWheres;
    ...
    public Where(
           ...
           com.easyinsight.dbservice.validated.DayWhere[] dayWheres,
     ...
     * @return dayWheres
     */
    public com.easyinsight.dbservice.validated.DayWhere[] getDayWheres() {
        return dayWheres;
    }
     ...
     * @param dayWheres
     */
    public void setDayWheres(com.easyinsight.dbservice.validated.DayWhere[] dayWheres) {
        this.dayWheres = dayWheres;
    }

    public com.easyinsight.dbservice.validated.DayWhere getDayWheres(int i) {
        return this.dayWheres[i];
    }

    public void setDayWheres(int i, com.easyinsight.dbservice.validated.DayWhere _value) {
