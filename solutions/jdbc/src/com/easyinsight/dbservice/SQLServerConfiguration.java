 ...
 * Time: 2:47:05 PM
 */
public class SQLServerConfiguration extends DBConfiguration {
    private String databaseName;
    private String host;
    private String port;
    private String userName;
    private String password;
    private String connectionString = "jdbc:sqlserver://{0}:{1}/{2}?user={3}&password={4}";
    ...
    public void save(Connection conn) throws SQLException, StringEncrypter.EncryptionException {
        PreparedStatement insertUserStmt = conn.prepareStatement("INSERT INTO SQL_SERVER_CONFIG (HOST, PORT, DATABASE, USERNAME, PASSWORD) VALUES (?, ?, ?, ?, ?)");
    ...
    public void load(Connection conn) throws SQLException, StringEncrypter.EncryptionException {
        PreparedStatement loadStmt = conn.prepareStatement("SELECT HOST, PORT, DATABASE, USERNAME, PASSWORD FROM SQL_SERVER_CONFIG");
