...
public class Where  implements java.io.Serializable {
     ...
     * @return dateWheres
     */
    public com.easyinsight.solutions.dbservice.webservice.DateWhere[] getDateWheres() {
        return dateWheres;
    }
     ...
     * @param dateWheres
     */
    public void setDateWheres(com.easyinsight.solutions.dbservice.webservice.DateWhere[] dateWheres) {
        this.dateWheres = dateWheres;
    }

    public com.easyinsight.solutions.dbservice.webservice.DateWhere getDateWheres(int i) {
     ...
     * @return numberWheres
     */
    public com.easyinsight.solutions.dbservice.webservice.NumberWhere[] getNumberWheres() {
        return numberWheres;
    }
     ...
     * @param numberWheres
     */
    public void setNumberWheres(com.easyinsight.solutions.dbservice.webservice.NumberWhere[] numberWheres) {
        this.numberWheres = numberWheres;
    }

    public com.easyinsight.solutions.dbservice.webservice.NumberWhere getNumberWheres(int i) {
        return this.numberWheres[i];
    }

    public void setNumberWheres(int i, com.easyinsight.solutions.dbservice.webservice.NumberWhere _value) {
     ...
     * @return stringWheres
     */
    public com.easyinsight.solutions.dbservice.webservice.StringWhere[] getStringWheres() {
        return stringWheres;
    }
     ...
     * @param stringWheres
     */
    public void setStringWheres(com.easyinsight.solutions.dbservice.webservice.StringWhere[] stringWheres) {
        this.stringWheres = stringWheres;
    }

    public com.easyinsight.solutions.dbservice.webservice.StringWhere getStringWheres(int i) {
        return this.stringWheres[i];
    }

    public void setStringWheres(int i, com.easyinsight.solutions.dbservice.webservice.StringWhere _value) {
