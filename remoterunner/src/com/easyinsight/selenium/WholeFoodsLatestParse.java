...
import com.easyinsight.rowutil.v2web.Comparison;
 ...
 * Time: 4:20:53 PM
 */
public class WholeFoodsLatestParse implements IWholeFoodsParse {

    private RowUtil rowUtil;

    private boolean updatedWhere = false;

    public WholeFoodsLatestParse(String apiKey, String secretKey, String dataSourceName) throws RemoteException {
        rowUtil = new RowUtil(RowMethod.UPDATE, apiKey, secretKey,  dataSourceName, true,
